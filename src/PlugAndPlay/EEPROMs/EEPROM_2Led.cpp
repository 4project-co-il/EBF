...
void setup()
{
	...
	deviceInfo.deviceIDs[0] = PNP_ID_2LED;
	...
	deviceInfo.interrupt1Mode = PnP_InterruptMode::PNP_DIGITAL_OUTPUT;
	deviceInfo.interrupt2Mode = PnP_InterruptMode::PNP_DIGITAL_OUTPUT;
