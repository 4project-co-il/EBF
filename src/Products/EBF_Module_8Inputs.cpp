...
// Initializing EBF_Module_8Inputs class instance.
// The i2cAddress should specify the device I2C address
uint8_t EBF_Module_8Inputs::Init(uint8_t i2cAddress)
{
	uint8_t rc;
...
uint8_t EBF_Module_8Inputs::AttachInterrupt(uint8_t interruptPin)
{
	uint8_t rc;
...
uint8_t EBF_Module_8Inputs::Process()
{
	EBF_Logic *pLogic = EBF_Logic::GetInstance();
...
#ifdef EBF_USE_INTERRUPTS
void EBF_Module_8Inputs::ProcessInterrupt()
{
	uint8_t rc;
...
uint8_t EBF_Module_8Inputs::PostponeProcessing(uint8_t eventIndex, uint8_t inputValues)
{
	uint8_t rc;
	EBF_Logic *pLogic = EBF_Logic::GetInstance();
	PostponedInterruptData data = {0};
...
uint8_t EBF_Module_8Inputs::GetValue(uint8_t index)
{
...
uint8_t EBF_Module_8Inputs::GetValues()
{
	uint8_t rc;
	uint8_t values;
...
uint8_t EBF_Module_8Inputs::GetLastValue(uint8_t index)
{
...
uint8_t EBF_Module_8Inputs::GetLastValues()
{
	return lastValues;
}

void EBF_Module_8Inputs::ExecuteCallback()
{
