...
class EBF_Seeed_Monochrome_GROVE_16x2_LCD : protected EBF_HalInstance, protected EBF_I2CDevice, public Print {
	protected:
		// commands
	...
	public:
		EBF_Seeed_Monochrome_GROVE_16x2_LCD(EBF_I2C &i2cInterface) : EBF_I2CDevice(&i2cInterface) { }
		EBF_Seeed_Monochrome_GROVE_16x2_LCD(EBF_I2C *pI2cInterface) : EBF_I2CDevice(pI2cInterface) { }
