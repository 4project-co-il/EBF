#ifndef __EBF_MODULE_8INPUTS_H__
#define __EBF_MODULE_8INPUTS_H__
...
class EBF_Module_8Inputs : public EBF_HalInstance {
	private:
		EBF_DEBUG_MODULE_NAME("EBF_Module_8Inputs");

	public:
		EBF_Module_8Inputs(EBF_I2C &i2cInterface) : chip(i2cInterface) {}
		EBF_Module_8Inputs(EBF_I2C* pI2cInterface) : chip(pI2cInterface) {}

		static const uint8_t numberOfInputs = 8;
